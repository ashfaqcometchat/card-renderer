Pod::Spec.new do |spec|
  ...
  spec.version          = '5.0.3-mutationprobe'
  ...
  spec.source           = { :http => 'https://dl.cloudsmith.io/public/cometchat/call-team/raw/versions/5.0.3-mutationprobe/CometChatCallsSDK-5.0.3-mutationprobe.zip' }
