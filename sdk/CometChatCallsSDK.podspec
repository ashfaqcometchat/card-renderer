Pod::Spec.new do |spec|
  ...
  spec.source           = { :http => 'https://dl.cloudsmith.io/public/cometchat/call-team/raw/versions/5.0.3-citest.2/CometChatCallsSDK-5.0.3-citest.2.zip' }
