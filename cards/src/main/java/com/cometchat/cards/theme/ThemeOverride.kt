...
data class CometChatCardThemeOverride(
    ...
    val codeBlockLangLabel: CometChatCardColorValue? = null,
    val chipFilledBg: CometChatCardColorValue? = null,
    val chipFilledText: CometChatCardColorValue? = null,
    val badgeBg: CometChatCardColorValue? = null,
    val badgeText: CometChatCardColorValue? = null,
    val avatarBg: CometChatCardColorValue? = null,
    val avatarText: CometChatCardColorValue? = null,
    ...
    val accordionHeaderBg: CometChatCardColorValue? = null,
    val accordionBorderColor: CometChatCardColorValue? = null,
    val tableHeaderBg: CometChatCardColorValue? = null,
    val tableStripedRowBg: CometChatCardColorValue? = null,
