Pod::Spec.new do |spec|
  ...
  spec.source          = { :http => 'https://dl.cloudsmith.io/public/cometchat/call-team/raw/versions/4.1.6-citest.4/CometChatSDK_4_1_6-citest_4.zip'}
