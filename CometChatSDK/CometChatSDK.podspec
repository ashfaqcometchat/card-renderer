Pod::Spec.new do |spec|
  ...
  spec.source          = { :http => 'https://dl.cloudsmith.io/public/cometchat/call-team/raw/versions/4.1.6-citest.3/CometChatSDK_4_1_6-citest_3.zip'}
